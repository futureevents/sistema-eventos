# Arquitetura — Sistema Eventos

Documento de referência da arquitetura do sistema. As regras curtas e imperativas
ficam no `../CLAUDE.md`; aqui fica o detalhamento.

Relacionados: `../CLAUDE.md`, `index.md`.
...
## Navegação: Space > Folder > List > View > Task
